    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system: `You are an analytics assistant for a streaming/content platform dashboard. You have access to this data:
CONTENT: ${JSON.stringify(CONTENT_DATA)}
COUNTRIES: ${JSON.stringify(COUNTRIES)}
PEAK_HOURS: ${JSON.stringify(PEAK_HOURS)}
Answer concisely with data-backed insights. Use bullet points for lists. If asked what to remove, recommend based on low views, negative trend, and low retention. If asked what to keep, recommend based on high views, positive trend, high retention.`,
