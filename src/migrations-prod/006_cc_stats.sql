...
ORDER BY (minute, platform, country, video_type, category, content_id)
...
active_runs AS (
    SELECT
        video_session_id, user_id, minute AS run_start, platform, country,
        video_type, category, content_id,
...
active_minutes AS (
    SELECT
        video_session_id, user_id, platform, country, video_type, category, content_id,
...
SELECT
    ...
    coalesce(a.video_type, o.video_type) AS video_type,
    coalesce(a.category, o.category) AS category,
...
GROUP BY minute, platform, country, video_type, category, content_id;
